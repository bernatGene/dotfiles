...
<important>
If the PR is >1000 lines (excluding autogenerated lock or openapi client files), go
directly to phase 6; publish a comment saying the PR is too large and you won't review.
</important>
