...
> [!IMPORTANT]
> the venv with zajec is usually inside the backend dir. If not available, stop, don't
> use other tools (e.g. gh)
...
> **Use subagents** - To increase the search space, in the steps that require it, invoke subagents as requested.
...
> **SUBAGENT task**
> Run two subagents with this same task and then retrieve and parse their findings into
> a single summary.
